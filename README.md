...
[![live demo](https://img.shields.io/badge/live%20demo-vitalpoint.vercel.app-0d6e66)](https://vitalpoint.vercel.app)
...
### ▸ [Open the live demo](https://vitalpoint.vercel.app)

All 300 accounts, scored and cited — no signup, nothing to install. Sort by
risk, filter by specialty or state, then open any account to see the brief and
the documents behind every claim.
...
*(Screenshots below; everything shown here is clickable in the
[live demo](https://vitalpoint.vercel.app).)*
...
Live at **[vitalpoint.vercel.app](https://vitalpoint.vercel.app)**, deployed to
Vercel as a single Python function with no build step:
